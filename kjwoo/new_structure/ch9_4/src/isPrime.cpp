...
/*
is_prime<10>
    static const bool result = _is_prime<INT<10>>::result;

_is_prime<INT<10>>
    static const bool result = !check_div<INT<10>, two>::result;

check_div<INT<10>,two>
    static const bool result = (INT<10>::num % two::num == 0) || check_div<INT<10>, typename add<two,
one>::result>::result;

(INT<10>::num % two::num == 0) -> true

check_div<INT<10>, typename add<two, one>::result>

add<two, one>
typedef INT<two::num + one::num> result;

check_div<INT<10>, typename INT<3>>
    static const bool result = !check_div<INT<10>, INT<3>>::result;
